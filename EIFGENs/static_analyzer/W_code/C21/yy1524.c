...
extern EIF_TYPED_VALUE F1524_15934(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1524_15934 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1523, Current, 4, 1, 21161);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1523, Current, 21161);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
			...
			default:
				...
				if ((EIF_BOOLEAN)(arg1 == ((EIF_INTEGER_32) 0L))) {
					...
					for (;;) {
						...
						uc1 = tc1;
						ui4_1 = loc2;
						(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(1738, "put", Result))(Result, uc1x, ui4_1x);
