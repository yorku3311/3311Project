...
extern void F1539_10090(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1539_10091(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1539_10092(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1539_10093(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1539_10094(EIF_REFERENCE);
extern void F1539_16354(EIF_REFERENCE, int);
...
void F1539_10090 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1538, Current, 0, 3, 15726);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1538, Current, 15726);
	RTCC(arg1, 1538, l_feature_name, 1, eif_non_attached_type(RTWCT(7810, dtype, Dftype(Current))));
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7807, 0xF8000000, 0); /* item */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(7807, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7808, 0x04000000, 1); /* after */
	
	*(EIF_BOOLEAN *)(Current + RTWA(7808, dtype)) = (EIF_BOOLEAN) arg3;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7809, 0x04000000, 1); /* before */
	
	*(EIF_BOOLEAN *)(Current + RTWA(7809, dtype)) = (EIF_BOOLEAN) arg2;
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
void F1539_10091 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1538, Current, 0, 1, 15727);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1538, Current, 15727);
	RTCC(arg1, 1538, l_feature_name, 1, RTWCT(7810, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F1539_10092 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1539_10093 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F1539_10094 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
