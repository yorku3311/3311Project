...
extern EIF_TYPED_VALUE F985_8914(EIF_REFERENCE);
extern EIF_TYPED_VALUE F985_8915(EIF_REFERENCE);
extern EIF_TYPED_VALUE F985_8916(EIF_REFERENCE);
...
EIF_TYPED_VALUE F985_8914 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 984, Current, 0, 0, 14491);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(984, Current, 14491);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F985_8915 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 984, Current, 0, 0, 14492);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(984, Current, 14492);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000458, 0,0); /* Result */
...
EIF_TYPED_VALUE F985_8916 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 984, Current, 0, 0, 14493);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(984, Current, 14493);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000458, 0,0); /* Result */
