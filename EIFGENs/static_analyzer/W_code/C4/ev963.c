...
extern EIF_TYPED_VALUE F963_8834(EIF_REFERENCE);
...
EIF_TYPED_VALUE F963_8834 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 962, Current, 0, 0, 14443);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(962, Current, 14443);
	RTIV(Current, RTAL);
	RTHOOK(1);
