...
extern EIF_TYPED_VALUE F1490_15236(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1490_15236 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1489, Current, 0, 0, 20564);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1489, Current, 20564);
	RTIV(Current, RTAL);
	RTHOOK(1);
