...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 928, Current, 0, 0, 14244);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(928, Current, 14244);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 928, Current, 0, 2, 14245);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(928, Current, 14245);
	RTCC(arg1, 928, l_feature_name, 1, eif_attached_type(1071));
	RTCC(arg2, 928, l_feature_name, 2, eif_attached_type(172));
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
