...
static EIF_TYPED_VALUE F950_8773_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F950_8773(EIF_REFERENCE);
extern EIF_TYPED_VALUE F950_8774(EIF_REFERENCE);
static EIF_TYPED_VALUE F950_8776_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F950_8776(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 949, Current, 0, 0, 14399);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(949, Current, 14399);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6684, 0xF8000458, 0); /* select_actions_internal */
...
static EIF_TYPED_VALUE F950_8773_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 949, Current, 0, 0, 14396);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(949, Current, 14396);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F950_8773 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6684, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F950_8773_body (Current)).it_r;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 949, Current, 0, 0, 14397);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(949, Current, 14397);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6687, 0xF8000458, 0); /* deselect_actions_internal */
...
static EIF_TYPED_VALUE F950_8776_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 949, Current, 0, 0, 14398);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(949, Current, 14398);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F950_8776 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6687, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F950_8776_body (Current)).it_r;
