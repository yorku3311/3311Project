...
static EIF_TYPED_VALUE F1338_12973_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1338_12973(EIF_REFERENCE);
extern void F1338_16410(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1338_12973_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1337, Current, 0, 0, 18711);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1337, Current, 18711);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1338_12973 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9319, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1338_12973_body (Current)).it_r;
...
void F1338_16410 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1337, Current, 0, 16409);
	RTSA(dtype);
	RTME(dtype, 0);
