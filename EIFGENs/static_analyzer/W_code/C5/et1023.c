...
extern void F1023_9331(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ETF_ENUM_PARAM}.make */
void F1023_9331 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1022, Current, 0, 1, 14832);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1022, Current, 14832);
	{
		...
		RTCC(arg1, 1022, l_feature_name, 1, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 7151, 0xF80000F9, 0); /* items */
...
EIF_TYPED_VALUE F1023_9333 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1022, Current, 0, 0, 14834);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1022, Current, 14834);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1022, Current, 1, 0, 14835);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1022, Current, 14835);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DB, 0,0); /* Result */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1022, Current, 1, 0, 14836);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1022, Current, 14836);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DB, 0,0); /* Result */
