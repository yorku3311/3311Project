...
static EIF_TYPED_VALUE F995_9014_body(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14570);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 14570);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6884, 0xF8000455, 0); /* pick_actions_internal */
...
static EIF_TYPED_VALUE F995_9005_body (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14571);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(994, Current, 14571);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14572);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 14572);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6887, 0xF800044E, 0); /* pick_ended_actions_internal */
...
static EIF_TYPED_VALUE F995_9008_body (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14573);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(994, Current, 14573);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14574);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 14574);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6890, 0xF8000458, 0); /* conforming_pick_actions_internal */
...
static EIF_TYPED_VALUE F995_9011_body (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14575);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(994, Current, 14575);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14576);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 14576);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6893, 0xF8000448, 0); /* drop_actions_internal */
		...
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(6893, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	}
	RTHOOK(3);
	RTDBGAL(Current, 0, 0xF8000448, 0,0); /* Result */
	
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6893, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("not_void", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
static EIF_TYPED_VALUE F995_9014_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14577);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(994, Current, 14577);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F995_9014 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6893, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F995_9014_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6893,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
