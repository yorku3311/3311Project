...
extern EIF_TYPED_VALUE F996_9016(EIF_REFERENCE);
extern EIF_TYPED_VALUE F996_9017(EIF_REFERENCE);
...
EIF_TYPED_VALUE F996_9015 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 995, Current, 0, 0, 14578);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(995, Current, 14578);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F996_9016 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 995, Current, 0, 0, 14579);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(995, Current, 14579);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F996_9017 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 995, Current, 0, 0, 14580);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(995, Current, 14580);
	RTIV(Current, RTAL);
	RTHOOK(1);
