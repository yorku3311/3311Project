...
extern EIF_TYPED_VALUE F1249_11520(EIF_REFERENCE);
extern void F1249_11521(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1249_11520 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1249_11521 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1248, Current, 0, 0, 17420);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1248, Current, 17420);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8388, 0xF800056D, 0); /* implementation */
