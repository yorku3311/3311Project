...
extern EIF_TYPED_VALUE F1248_11518(EIF_REFERENCE);
extern void F1248_11519(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1248_11518 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1248_11519 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1247, Current, 0, 0, 17418);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1247, Current, 17418);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8388, 0xF800056C, 0); /* implementation */
