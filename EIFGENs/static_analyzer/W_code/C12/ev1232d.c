...
static EIF_TYPE_INDEX gen_type13_1232 [] = {0xFF11,1353,0xFFFF};
static EIF_TYPE_INDEX gen_type14_1232 [] = {0xFF11,1324,0xFFFF};


static struct desc_info desc_1232[] = {
	{(BODY_INDEX) 17119, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
...
void Init1232(void)
{
	...
	IDSC(desc_1232 + 32, 486, 1231);
	IDSC(desc_1232 + 47, 871, 1231);
	IDSC(desc_1232 + 50, 993, 1231);
}
