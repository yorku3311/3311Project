...
extern void F1138_10377(EIF_REFERENCE);
...
/* {ETF_ADD_SUM}.add_sum */
void F1138_10377 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "add_sum";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1137, Current, 0, 0, 16159);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
