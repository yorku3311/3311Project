...
EIF_TYPED_VALUE F919_8557 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 918, Current, 0, 0, 14210);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(918, Current, 14210);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F919_8558 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 918, Current, 0, 0, 14211);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(918, Current, 14211);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x40000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6478, Dtype(Current)))(Current)).it_p);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
