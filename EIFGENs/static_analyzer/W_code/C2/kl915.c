...
extern EIF_TYPED_VALUE F915_8486(EIF_REFERENCE);
...
RTOID (F915_8486)
EIF_TYPED_VALUE F915_8486 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 914, Current, 0, 0, 14133);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(914, Current, 14133);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
