...
extern EIF_TYPED_VALUE F1281_11926(EIF_REFERENCE);
extern void F1281_11927(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1281_11926 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1281_11927 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1280, Current, 0, 0, 17827);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1280, Current, 17827);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8388, 0xF80005A6, 0); /* implementation */
