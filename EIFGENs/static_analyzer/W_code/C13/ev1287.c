...
extern EIF_TYPED_VALUE F1287_11955(EIF_REFERENCE);
extern void F1287_11956(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1287_11955 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1287_11956 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1286, Current, 0, 0, 17856);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1286, Current, 17856);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8388, 0xF80005B0, 0); /* implementation */
