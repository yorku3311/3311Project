...
extern EIF_TYPED_VALUE F1268_11772(EIF_REFERENCE);
extern void F1268_11773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1268_11772 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1268_11773 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1267, Current, 0, 0, 17673);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1267, Current, 17673);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8388, 0xF8000588, 0); /* implementation */
