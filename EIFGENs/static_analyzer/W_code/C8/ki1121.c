...
extern void F1121_10249(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1121_10250(EIF_REFERENCE);
...
void F1121_10249 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1120, Current, 0, 1, 16036);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1120, Current, 16036);
	RTCC(arg1, 1120, l_feature_name, 1, eif_attached_type(219));
	RTIV(Current, RTAL);
...
void F1121_10250 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1120, Current, 0, 0, 16037);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1120, Current, 16037);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_write", EX_PRE);
