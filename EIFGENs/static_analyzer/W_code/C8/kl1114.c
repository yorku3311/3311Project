...
extern EIF_TYPED_VALUE F1114_10226(EIF_REFERENCE);
...
RTOID (F1114_10226)
EIF_TYPED_VALUE F1114_10226 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1113, Current, 0, 0, 16018);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1113, Current, 16018);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
