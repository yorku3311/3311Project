...
extern void F1091_16445(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {UNARY_OP}.add_operation */
void F1091_16445 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1090, Current, 0, 1, 15772);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1090, Current, 15772);
	RTCC(arg1, 1090, l_feature_name, 1, eif_attached_type(1079));
	RTIV(Current, RTAL);
	RTHOOK(1);
