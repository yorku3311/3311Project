...
static EIF_TYPE_INDEX gen_type13_1205 [] = {0xFF11,1305,0xFFFF};
static EIF_TYPE_INDEX gen_type14_1205 [] = {0xFF11,1324,0xFFFF};


static struct desc_info desc_1205[] = {
	{(BODY_INDEX) 16737, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
