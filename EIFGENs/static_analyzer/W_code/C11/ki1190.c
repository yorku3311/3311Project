...
extern EIF_TYPED_VALUE F1190_10657(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1190_10658(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1190_10657 (EIF_REFERENCE Current)
{
	GTCX
...
body:;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8222, dtype))(Current)).it_b);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_TYPED_VALUE F1190_10658 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1189, Current, 0, 1, 16496);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6338, "maximum_byte_code", tr1))(tr1)).it_i4);
