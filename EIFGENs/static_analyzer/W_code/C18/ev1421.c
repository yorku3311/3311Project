...
extern EIF_TYPED_VALUE F1421_13946(EIF_REFERENCE);
extern void F1421_13951(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1421_13952(EIF_REFERENCE);
static EIF_TYPED_VALUE F1421_13953_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1421_13953(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1421_13946 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1420, Current, 1, 0, 19443);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1420, Current, 19443);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1784, "index", tr1))(tr1)).it_i4);
	...
	for (;;) {
		...
		RTNHOOK(5,2);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8683, "is_selected", tr2))(tr2)).it_b);
...
void F1421_13951 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1420, Current, 0, 0, 19440);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1420, Current, 19440);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 10600, 0x04000000, 1); /* default_key_processing_disabled */
	
	*(EIF_BOOLEAN *)(Current + RTWA(10600, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1421_13952 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {EV_LIST_I}.interface */
static EIF_TYPED_VALUE F1421_13953_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1420, Current, 0, 0, 19442);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1420, Current, 19442);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1421_13953 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9319, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1421_13953_body (Current)).it_r;
