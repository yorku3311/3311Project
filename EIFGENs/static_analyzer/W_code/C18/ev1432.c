...
extern void F1432_14218(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1432_14219(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1432_14220(EIF_REFERENCE);
extern void F1432_14221(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1432_14222(EIF_REFERENCE);
extern void F1432_14223(EIF_REFERENCE);
extern void F1432_14224(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1432_14225(EIF_REFERENCE);
static EIF_TYPED_VALUE F1432_14226_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1432_14226(EIF_REFERENCE);
...
void F1432_14218 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1431, Current, 0, 1, 19642);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1431, Current, 19642);
	RTCC(arg1, 1431, l_feature_name, 1, RTWCT(9319, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
/* {EV_LABEL_IMP}.make */
void F1432_14219 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1431, Current, 2, 0, 19643);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(14218,1);
	RTDBGEAA(1431, Current, 19643);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(4,1);
	RTCOMS(tr2,14218,0,"justify",7,1848530809);
	ur1 = tr2;
...
/* {EV_LABEL_IMP}.angle */
EIF_TYPED_VALUE F1432_14220 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL32;
	r.it_r4 = *(EIF_REAL_32 *)(Current + RTWA(10750,Dtype(Current)));
	return r;
}


/* {EV_LABEL_IMP}.set_angle */
void F1432_14221 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 1431, Current, 0, 1, 19645);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1431, Current, 19645);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = *(EIF_POINTER *)(Current + RTWA(10117, dtype));
	up1 = tp1;
	ur4_1 = (EIF_REAL_32) ((EIF_REAL_32) ((EIF_REAL_64) (arg1) /  (EIF_REAL_64) ((EIF_REAL_32) 3.14)) * (EIF_REAL_32) 180.0);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5595, 869))(Current, up1x, ur4_1x);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10750, 0x18000000, 1); /* angle */
	
	*(EIF_REAL_32 *)(Current + RTWA(10750, dtype)) = (EIF_REAL_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
void F1432_14222 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1431, Current, 0, 0, 19646);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1431, Current, 19646);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1432_14223 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1431, Current, 0, 0, 19647);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1431, Current, 19647);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1432_14224 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1431, Current, 0, 0, 19648);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1431, Current, 19648);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1432_14225 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
static EIF_TYPED_VALUE F1432_14226_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1431, Current, 0, 0, 19650);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1431, Current, 19650);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1432_14226 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9319, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1432_14226_body (Current)).it_r;
