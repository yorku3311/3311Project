...
extern EIF_TYPED_VALUE F1307_12152(EIF_REFERENCE);
extern void F1307_12154(EIF_REFERENCE);
extern void F1307_12155(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1307_12156(EIF_REFERENCE);
static EIF_TYPED_VALUE F1307_12157_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1307_12157(EIF_REFERENCE);
extern void F1307_16403(EIF_REFERENCE, int);
...
/* {EV_TIMEOUT_I}.count */
EIF_TYPED_VALUE F1307_12152 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
void F1307_12154 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1306, Current, 0, 0, 18056);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1306, Current, 18056);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	if (RTAL & CK_ENSURE) {
		...
		tb2 = '\0';
		tb3 = '\0';
		tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9317, dtype))(Current)).it_b);
		if ((EIF_BOOLEAN) !tb4) {
			tb4 = *(EIF_BOOLEAN *)(Current + RTWA(9344, dtype));
			tb3 = (EIF_BOOLEAN) !tb4;
		}
		if (tb3) {
			RTCO(tr1);
		...
		if (tb2) {
			ti4_3 = *(EIF_INTEGER_32 *)(Current + RTWA(9340, dtype));
			RTCO(tr2);
			ti4_4 = *(EIF_INTEGER_32 *)(Current + RTWA(9340, dtype));
...
EIF_TYPED_VALUE F1307_12156 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
static EIF_TYPED_VALUE F1307_12157_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1306, Current, 0, 0, 18059);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1306, Current, 18059);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1307_12157 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9319, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1307_12157_body (Current)).it_r;
