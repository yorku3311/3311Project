...
extern EIF_TYPED_VALUE F1302_12103(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1302_12104(EIF_REFERENCE);
extern void F1302_16399(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1302_12103 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1301, Current, 1, 1, 18007);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1301, Current, 18007);
	RTCC(arg1, 1301, l_feature_name, 1, eif_attached_type(RTWCT(1741, dtype, Dftype(Current))));
	RTIV(Current, RTAL);
...
body:;
	...
	loc1 = RTRV(eif_non_attached_type(1301), loc1);
	RTHOOK(4);
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		if (!RTEQ(tr1, arg1)) {
			ur1 = RTCCL(arg1);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(8801, "is_parent_recursive", loc1))(loc1, ur1x)).it_b);
...
EIF_TYPED_VALUE F1302_12104 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
