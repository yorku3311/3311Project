...
extern EIF_TYPED_VALUE F1581_8552(EIF_REFERENCE);
extern void F1581_8553(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1581_8554(EIF_REFERENCE);
...
/* {KL_LINKABLE}.right */
EIF_TYPED_VALUE F1581_8552 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1581_8553 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1580, Current, 0, 1, 14206);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1580, Current, 14206);
	RTCC(arg1, 1580, l_feature_name, 1, eif_attached_type(Dftype(Current)));
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6473, 0xF800062C, 0); /* right */
...
void F1581_8554 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1580, Current, 0, 0, 14207);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1580, Current, 14207);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6473, 0xF800062C, 0); /* right */
