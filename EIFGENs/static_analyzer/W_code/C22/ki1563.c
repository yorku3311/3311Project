...
extern void F1563_8307(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1563_8309(EIF_REFERENCE);
extern void F1563_8311(EIF_REFERENCE);
...
void F1563_8307 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1562, Current, 0, 1, 13987);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1562, Current, 13987);
	{
		static EIF_TYPE_INDEX typarr0[] = {1553,0,0xFFFF};
		EIF_TYPE_INDEX typres0;
		typarr0[1] = RTWCT(6239, dtype, Dftype(Current));
		
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		RTCC(arg1, 1562, l_feature_name, 1, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(5);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6864, "read", arg1))(arg1);
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6873, "last_item", arg1))(arg1)).it_c1);
...
EIF_TYPED_VALUE F1563_8309 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1562, Current, 0, 0, 13985);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1562, Current, 13985);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1563_8311 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1562, Current, 0, 0, 13986);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1562, Current, 13986);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
