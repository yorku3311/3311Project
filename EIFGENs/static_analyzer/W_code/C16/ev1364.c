...
extern EIF_TYPED_VALUE F1364_13186(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1364_13186 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1363, Current, 0, 0, 18865);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1363, Current, 18865);
	RTIV(Current, RTAL);
	RTHOOK(1);
