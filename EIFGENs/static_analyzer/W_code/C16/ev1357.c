...
extern EIF_TYPED_VALUE F1357_13136(EIF_REFERENCE);
extern void F1357_13137(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1357_13140(EIF_REFERENCE);
static EIF_TYPED_VALUE F1357_13141_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1357_13141(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1357_13136 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1356, Current, 3, 0, 18829);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1356, Current, 18829);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5382, 868))(Current, up1x)).it_p);
	RTHOOK(3);
	if ((EIF_BOOLEAN)(loc1 != loc2)) {
		RTHOOK(4);
		up1 = loc1;
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5524, 868))(Current, up1x)).it_p);
		up1 = tp1;
...
void F1357_13137 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1356, Current, 3, 1, 18830);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1356, Current, 18830);
	RTCC(arg1, 1356, l_feature_name, 1, eif_attached_type(216));
	RTIV(Current, RTAL);
...
body:;
	...
	up3 = tp3;
	up4 = loc3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5386, 868))(Current, up1x, up2x, up3x, up4x);
	RTHOOK(4);
...
EIF_TYPED_VALUE F1357_13140 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1356, Current, 0, 0, 18831);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1356, Current, 18831);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1357_13141_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1356, Current, 0, 0, 18832);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1356, Current, 18832);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1357_13141 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9319, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1357_13141_body (Current)).it_r;
