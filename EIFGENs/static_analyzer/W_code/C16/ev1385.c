...
extern void F1385_13491(EIF_REFERENCE);
extern void F1385_13492(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1385_13493(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1385_13494(EIF_REFERENCE);
static EIF_TYPED_VALUE F1385_13495_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1385_13495(EIF_REFERENCE);
...
void F1385_13491 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1384, Current, 0, 0, 19101);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9314, 1547))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1385_13492 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1384, Current, 1, 2, 19102);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1384, Current, 19102);
	RTCC(arg1, 1384, l_feature_name, 1, eif_attached_type(RTWCT(10282, dtype, Dftype(Current))));
	RTIV(Current, RTAL);
...
void F1385_13493 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1384, Current, 2, 1, 19103);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(9913, dtype)) = (EIF_INTEGER_32) loc2;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(11);
...
EIF_TYPED_VALUE F1385_13494 (EIF_REFERENCE Current)
{
	GTCX
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10305, Dtype(Current)))(Current)).it_p);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
static EIF_TYPED_VALUE F1385_13495_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1385_13495 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9319, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1385_13495_body (Current)).it_r;
