...
extern EIF_TYPED_VALUE F1060_9800(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1060_9800 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1059, Current, 0, 0, 15292);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1059, Current, 15292);
	RTIV(Current, RTAL);
