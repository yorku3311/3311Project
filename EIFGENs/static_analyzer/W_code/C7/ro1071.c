...
extern void F1071_9996(EIF_REFERENCE);
extern void F1071_9997(EIF_REFERENCE);
extern void F1071_16352(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1071_9995 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1070, Current, 0, 0, 15627);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1070, Current, 15627);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7712, Dtype(Current)))(Current)).it_i4);
...
/* {ROOT}.add_tests */
void F1071_9996 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1070, Current, 0, 0, 15628);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1070, Current, 15628);
	RTIV(Current, RTAL);
...
void F1071_9997 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1070, Current, 2, 0, 15629);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1070, Current, 15629);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
		...
		switch (ti4_1) {
			case 1L:
				...
				if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
					...
					RTHOOK(10);
					(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(7209, dtype))(Current);
					RTHOOK(11);
			...
			case 5L:
				RTHOOK(16);
				(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(7674, dtype))(Current);
				break;
			default:
				if (RTAL & CK_CHECK) {
					RTHOOK(17);
...
/* {ROOT}._invariant */
void F1071_16352 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1070, Current, 0, 16351);
	RTSA(dtype);
	RTME(dtype, 0);
