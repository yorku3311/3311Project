...
extern void F1075_10056(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1075_10057(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1075_10058(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1075_10059(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1075_10060(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1075_10061(EIF_REFERENCE);
...
void F1075_10056 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1074, Current, 0, 0, 15706);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1074, Current, 15706);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7777, 0xF8000530, 0); /* application_i */
	...
	*(EIF_REFERENCE *)(Current + RTWA(7777, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7780, 0xF8000084, 0); /* internal_helper */
	
	tr1 = RTLNSMART(eif_non_attached_type(RTWCT(7780, dtype, Dftype(Current))));
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(32, Dtype(tr1)))(tr1);
	
	RTNHOOK(2,1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7780, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F1075_10057 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1074, Current, 0, 0, 15707);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1074, Current, 15707);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1075_10058 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1075_10059 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1074, Current, 1, 1, 15709);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1074, Current, 15709);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTCT0(NULL, EX_CHECK);
	...
	loc1 = RTCCL(tr2);
	loc1 = RTRV(eif_non_attached_type(1204),loc1);
	if (EIF_TEST(loc1)) {
		RTCK0;
	} else {
		RTCF0;
...
EIF_TYPED_VALUE F1075_10060 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1074, Current, 4, 1, 15710);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1074, Current, 15710);
	RTCC(arg1, 1074, l_feature_name, 1, eif_attached_type(216));
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1075_10061 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
