...
extern EIF_TYPED_VALUE F1061_9801(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1061_9801 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1060, Current, 0, 0, 15293);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1060, Current, 15293);
	RTIV(Current, RTAL);
