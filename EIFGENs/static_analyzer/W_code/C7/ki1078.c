...
extern EIF_TYPED_VALUE F1078_10079(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1078_10079 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1077, Current, 0, 1, 15725);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1077, Current, 15725);
	RTCC(arg1, 1077, l_feature_name, 1, eif_attached_type(219));
	RTIV(Current, RTAL);
	RTHOOK(1);
