...
extern void F1040_9394(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1040_9395(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1040_9396(EIF_REFERENCE);
...
/* {ETF_CHAR_ARG}.make */
void F1040_9394 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1039, Current, 0, 1, 14895);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1039, Current, 14895);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_REFERENCE *)(Current + RTWA(7173, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7191, 0x08000000, 1); /* value */
	
	*(EIF_CHARACTER_8 *)(Current + RTWA(7191, dtype)) = (EIF_CHARACTER_8) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
/* {ETF_CHAR_ARG}.value */
EIF_TYPED_VALUE F1040_9395 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
	r.it_c1 = *(EIF_CHARACTER_8 *)(Current + RTWA(7191,Dtype(Current)));
	return r;
}


/* {ETF_CHAR_ARG}.out */
EIF_TYPED_VALUE F1040_9396 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1039, Current, 0, 0, 14897);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1039, Current, 14897);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DB, 0,0); /* Result */
	
	tr1 = RTMS_EX_H("\'",1,39);
	tc1 = *(EIF_CHARACTER_8 *)(Current + RTWA(7191, dtype));
	tr2 = c_outc(tc1);
