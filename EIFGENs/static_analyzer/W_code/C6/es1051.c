...
extern void F1051_9493(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1051_9494(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1051_9495(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1051_9496(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1051_9497(EIF_REFERENCE);
...
void F1051_9493 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1050, Current, 0, 2, 14987);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1050, Current, 14987);
	RTCC(arg1, 1050, l_feature_name, 1, eif_attached_type(219));
	{
		...
		RTCC(arg2, 1050, l_feature_name, 2, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7269, 0xF80000F1, 0); /* case */
	
	RTAR(Current, arg2);
	*(EIF_REFERENCE *)(Current + RTWA(7269, dtype)) = (EIF_REFERENCE) RTCCL(arg2);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7265, 0xF80000DB, 0); /* case_name */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(7265, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
	...
	*(EIF_REFERENCE *)(Current + RTWA(7267, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7271, 0xF80000DB, 0); /* expected_tag_name */
	
	tr1 = RTMS_EX_H("NONE",4,1313820229);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7271, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 7266, 0xF80000DB, 0); /* bookmark_name */
...
void F1051_9494 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1050, Current, 1, 3, 14988);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1050, Current, 14988);
	RTCC(arg1, 1050, l_feature_name, 1, eif_attached_type(219));
	{
		static EIF_TYPE_INDEX typarr0[] = {241,0xFF11,0,0xFF11,0xFFF9,0,173,0xFFFF};
		EIF_TYPE_INDEX typres0;
	...
	RTCC(arg3, 1050, l_feature_name, 3, eif_attached_type(219));
	RTIV(Current, RTAL);
...
void F1051_9495 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1050, Current, 3, 0, 14989);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1050, Current, 14989);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
	...
	ur1 = RTCCL(tr1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7271, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur2 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1051_9496 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1050, Current, 0, 0, 14990);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1050, Current, 14990);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1051_9497 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
