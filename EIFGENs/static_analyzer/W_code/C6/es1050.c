...
extern void F1050_9489(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1050_9490(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1050_9491(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1050_9492(EIF_REFERENCE);
...
void F1050_9489 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1049, Current, 0, 2, 14983);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1049, Current, 14983);
	RTCC(arg1, 1049, l_feature_name, 1, eif_attached_type(219));
	{
		...
		RTCC(arg2, 1049, l_feature_name, 2, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7269, 0xF8000111, 0); /* case */
...
EIF_TYPED_VALUE F1050_9491 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1049, Current, 0, 0, 14985);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1049, Current, 14985);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1050_9492 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
