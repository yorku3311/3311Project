...
extern void F1392_13566(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1392_13567(EIF_REFERENCE);
static EIF_TYPED_VALUE F1392_13568_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1392_13568(EIF_REFERENCE);
...
void F1392_13566 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1391, Current, 0, 1, 19165);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1391, Current, 19165);
	RTCC(arg1, 1391, l_feature_name, 1, RTWCT(9319, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
void F1392_13567 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1391, Current, 0, 0, 19166);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1391, Current, 19166);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1392_13568_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1391, Current, 0, 0, 19167);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1391, Current, 19167);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1392_13568 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9319, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1392_13568_body (Current)).it_r;
