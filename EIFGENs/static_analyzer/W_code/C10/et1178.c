...
extern void F1178_10437(EIF_REFERENCE);
...
/* {ETF_RESET}.reset */
void F1178_10437 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1177, Current, 0, 0, 16199);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1177, Current, 16199);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6193, "reset", tr1))(tr1);
